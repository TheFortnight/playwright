...
- Ported 1560 quick-order layout VRT to the current auth-based flow, added browser-specific stabilization, refreshed Chromium/Firefox/WebKit baselines, and verified headed reruns on staging.
